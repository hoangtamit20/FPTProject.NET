...
public partial class QlksdbContext : DbContext
{
    ...
    public virtual DbSet<HoaDonDichVuModel>? HoaDonDichVus { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HoaDonDichVuModel>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__HoaDonDi__3213E83FF33DE5CE");
            ...
            entity.HasOne(d => d.MaDpNavigation).WithOne(p => p.HoaDonDichVu)
                .HasPrincipalKey<DatPhongModel>(p => p.MaDp)
                .HasForeignKey<HoaDonDichVuModel>(d => d.MaDp)
                .OnDelete(DeleteBehavior.ClientSetNull)
